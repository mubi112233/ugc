        ...
        <div className="max-w-6xl mx-auto">
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className="flex-1 bg-card rounded-xl sm:rounded-2xl p-6 sm:p-8 md:p-10 hover:shadow-[0_25px_60px_-15px_hsl(45_80%_55%/0.4)] transition-all duration-500 group">
