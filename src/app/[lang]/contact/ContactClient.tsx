...
const translations: Record<string, Record<string, string>> = {
  en: {
    badge: "Get In Touch",
    title: "Let's Create Your UGC Strategy",
    subtitle: "Tell us about your product and goals. We'll craft a custom UGC plan with hook ideas and creator recommendations.",
    email: "Email Address",
    phone: "Phone Number",
    mainServiceLabel: "Service Needed",
    mainServicePlaceholder: "Select a service",
    mainServiceOtherLabel: "Describe your needs",
    mainServiceOtherPlaceholder: "Describe what you need...",
    vaCountLabel: "How many videos do you need?",
    vaCountPlaceholder: "e.g. 10",
    va1Label: "Video Package #1 — Details",
    va2IndustryLabel: "Video Package #2 — Type",
    va2Label: "Video Package #2 — Details",
    va3IndustryLabel: "Video Package #3 — Type",
    va3Label: "Video Package #3 — Details",
    va4IndustryLabel: "Video Package #4 — Type",
    va4Label: "Video Package #4 — Details",
    ...
    vaCountRequired: "Please enter the number of videos",
    ...
    feature1: "Vetted creators that match your brand",
    feature2: "60% cost savings vs studio ads",
    feature3: "Full commercial usage rights",
    feature4: "Performance tracking & optimization",
    responseTime: "We typically respond within 2 hours",
  },
  ge: {
    badge: "Kontakt aufnehmen",
    title: "Ihre UGC-Strategie entwickeln",
    subtitle: "Erzählen Sie uns von Ihrem Produkt und Ihren Zielen. Wir entwickeln eine maßgeschneiderte UGC-Strategie mit Hook-Ideen und Creator-Empfehlungen.",
    email: "E-Mail-Adresse",
    phone: "Telefonnummer",
    mainServiceLabel: "Gewünschter Service",
    mainServicePlaceholder: "Service auswählen",
    mainServiceOtherLabel: "Beschreiben Sie Ihre Bedürfnisse",
    mainServiceOtherPlaceholder: "Beschreiben Sie Ihre Anforderungen...",
    vaCountLabel: "Wie viele Videos benötigen Sie?",
    vaCountPlaceholder: "z.B. 10",
    va1Label: "Video-Paket #1 — Details",
    va2IndustryLabel: "Video-Paket #2 — Typ",
    va2Label: "Video-Paket #2 — Details",
    va3IndustryLabel: "Video-Paket #3 — Typ",
    va3Label: "Video-Paket #3 — Details",
    va4IndustryLabel: "Video-Paket #4 — Typ",
    va4Label: "Video-Paket #4 — Details",
    ...
    mainServiceRequired: "Bitte wählen Sie einen Service",
    vaCountRequired: "Bitte geben Sie die Anzahl der Videos ein",
    sideTitle: "Warum mit uns arbeiten?",
    stat1Value: "500+",
    stat1Label: "Marken bedient",
    stat2Value: "5-7 Tage",
    stat2Label: "Lieferzeit",
    stat3Value: "4.9/5",
    stat3Label: "Durchschnittsbewertung",
    feature1: "Geprüfte Creator, die zu Ihrer Marke passen",
    feature2: "60% günstiger als Studio-Werbespots",
    feature3: "Volle kommerzielle Nutzungsrechte",
    feature4: "Performance-Tracking & Optimierung",
          ...
          >
            ...
            <div className="p-5 bg-card border border-border/50 rounded-xl space-y-3">
              ...
              <p className="text-sm text-muted-foreground italic leading-relaxed">
                &ldquo;UGC Studio transformed our ad performance. Our TikTok ROAS increased 3x within the first month.&rdquo;
              </p>
